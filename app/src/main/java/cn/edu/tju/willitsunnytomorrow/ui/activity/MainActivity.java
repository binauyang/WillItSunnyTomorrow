package cn.edu.tju.willitsunnytomorrow.ui.activity;
...
//        getMenuInflater().inflate(R.menu.main, menu);
    ...
    private void initLocation() {
        LocationUtil.getInstance().requestLocation(getApplicationContext(), new LocationUtil.LocationRequestListener() {
            @Override
    ...
    private void initDate() {
        mDateTextView.setText(TimeUtil.getDate());
    }
}
